...
(function(){
  ...
  const PAIRS = [
    ...
    ['Permisos y respaldo legal','Permits & legal backing'],['Gestionamos el título de posesión, permisos y servicios. Todo en regla, con acompañamiento legal desde el día uno.','We handle the possession title, permits and utilities. Everything in order, with legal support from day one.'],
